...
public class Main {
	private static final String USAGE = "JavaZip.bat [options] files";
	private static final String HEADER = "Java utility for zipping/unzipping files v0.1";
	private static final String FOOTER = "Developed by Kashim Mohammed (C) 2021\n";
	public static void main(String[] args)
	{
		...
		try {
			...
			if (line.hasOption('v')) {
				System.out.println("JavaZip version v0.1\n");
				System.exit(0);
			}
